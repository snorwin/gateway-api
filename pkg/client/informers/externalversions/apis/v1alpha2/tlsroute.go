...
type TLSRouteIndexInformer cache.TypedSharedIndexInformer[*gatewayapiapisv1alpha2.TLSRoute]

// TLSRouteHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for TLSRoute.
type TLSRouteHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*gatewayapiapisv1alpha2.TLSRoute]

// TLSRouteDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for TLSRoute.
type TLSRouteDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*gatewayapiapisv1alpha2.TLSRoute]

// TLSRouteFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for TLSRoute.
type TLSRouteFilteringHandler = cache.TypedFilteringResourceEventHandler[*gatewayapiapisv1alpha2.TLSRoute]

// TLSRouteIndexers is a specialization of [cache.TypedIndexers] for TLSRoute.
type TLSRouteIndexers = cache.TypedIndexers[*gatewayapiapisv1alpha2.TLSRoute]

// DeletedTLSRoute is a specialization of [cache.DeletedObject] for TLSRoute.
type DeletedTLSRoute = cache.DeletedObject[*gatewayapiapisv1alpha2.TLSRoute]
...
func NewTypedTLSRouteInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) TLSRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.TLSRoute](cache.NewSharedIndexInformerWithOptions(
...
func (f *tLSRouteInformer) TypedInformer() TLSRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.TLSRoute](f.factory.InformerFor(&gatewayapiapisv1alpha2.TLSRoute{}, f.defaultInformer))
}
...
func (a *tLSRouteTypedInformerAdapter) TypedInformer() TLSRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.TLSRoute](a.Informer())
}
...
func ToTLSRouteIndexInformer(informer cache.SharedIndexInformer) TLSRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.TLSRoute](informer)
}
