...
type GRPCRouteIndexInformer cache.TypedSharedIndexInformer[*gatewayapiapisv1alpha2.GRPCRoute]

// GRPCRouteHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for GRPCRoute.
type GRPCRouteHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*gatewayapiapisv1alpha2.GRPCRoute]

// GRPCRouteDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for GRPCRoute.
type GRPCRouteDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*gatewayapiapisv1alpha2.GRPCRoute]

// GRPCRouteFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for GRPCRoute.
type GRPCRouteFilteringHandler = cache.TypedFilteringResourceEventHandler[*gatewayapiapisv1alpha2.GRPCRoute]

// GRPCRouteIndexers is a specialization of [cache.TypedIndexers] for GRPCRoute.
type GRPCRouteIndexers = cache.TypedIndexers[*gatewayapiapisv1alpha2.GRPCRoute]

// DeletedGRPCRoute is a specialization of [cache.DeletedObject] for GRPCRoute.
type DeletedGRPCRoute = cache.DeletedObject[*gatewayapiapisv1alpha2.GRPCRoute]
...
func NewTypedGRPCRouteInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) GRPCRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.GRPCRoute](cache.NewSharedIndexInformerWithOptions(
...
func (f *gRPCRouteInformer) TypedInformer() GRPCRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.GRPCRoute](f.factory.InformerFor(&gatewayapiapisv1alpha2.GRPCRoute{}, f.defaultInformer))
}
...
func (a *gRPCRouteTypedInformerAdapter) TypedInformer() GRPCRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.GRPCRoute](a.Informer())
}
...
func ToGRPCRouteIndexInformer(informer cache.SharedIndexInformer) GRPCRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1alpha2.GRPCRoute](informer)
}
