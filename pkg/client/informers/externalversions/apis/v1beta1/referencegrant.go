...
type ReferenceGrantIndexInformer cache.TypedSharedIndexInformer[*gatewayapiapisv1beta1.ReferenceGrant]

// ReferenceGrantHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for ReferenceGrant.
type ReferenceGrantHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*gatewayapiapisv1beta1.ReferenceGrant]
...
type ReferenceGrantDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*gatewayapiapisv1beta1.ReferenceGrant]

// ReferenceGrantFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for ReferenceGrant.
type ReferenceGrantFilteringHandler = cache.TypedFilteringResourceEventHandler[*gatewayapiapisv1beta1.ReferenceGrant]

// ReferenceGrantIndexers is a specialization of [cache.TypedIndexers] for ReferenceGrant.
type ReferenceGrantIndexers = cache.TypedIndexers[*gatewayapiapisv1beta1.ReferenceGrant]

// DeletedReferenceGrant is a specialization of [cache.DeletedObject] for ReferenceGrant.
type DeletedReferenceGrant = cache.DeletedObject[*gatewayapiapisv1beta1.ReferenceGrant]
...
func NewTypedReferenceGrantInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) ReferenceGrantIndexInformer {
	gvr := schema.GroupVersionResource{Group: "gateway.networking.k8s.io", Version: "v1beta1", Resource: "referencegrants"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1beta1.ReferenceGrant](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1beta1().ReferenceGrants(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1beta1().ReferenceGrants(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1beta1().ReferenceGrants(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1beta1().ReferenceGrants(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *referenceGrantInformer) TypedInformer() ReferenceGrantIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1beta1.ReferenceGrant](f.factory.InformerFor(&gatewayapiapisv1beta1.ReferenceGrant{}, f.defaultInformer))
}
...
func (a *referenceGrantTypedInformerAdapter) TypedInformer() ReferenceGrantIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1beta1.ReferenceGrant](a.Informer())
}
...
func ToReferenceGrantIndexInformer(informer cache.SharedIndexInformer) ReferenceGrantIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1beta1.ReferenceGrant](informer)
}
