...
type HTTPRouteIndexInformer cache.TypedSharedIndexInformer[*gatewayapiapisv1.HTTPRoute]

// HTTPRouteHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for HTTPRoute.
type HTTPRouteHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*gatewayapiapisv1.HTTPRoute]

// HTTPRouteDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for HTTPRoute.
type HTTPRouteDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*gatewayapiapisv1.HTTPRoute]

// HTTPRouteFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for HTTPRoute.
type HTTPRouteFilteringHandler = cache.TypedFilteringResourceEventHandler[*gatewayapiapisv1.HTTPRoute]

// HTTPRouteIndexers is a specialization of [cache.TypedIndexers] for HTTPRoute.
type HTTPRouteIndexers = cache.TypedIndexers[*gatewayapiapisv1.HTTPRoute]

// DeletedHTTPRoute is a specialization of [cache.DeletedObject] for HTTPRoute.
type DeletedHTTPRoute = cache.DeletedObject[*gatewayapiapisv1.HTTPRoute]
...
func NewTypedHTTPRouteInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) HTTPRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1.HTTPRoute](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1().HTTPRoutes(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1().HTTPRoutes(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.GatewayV1().HTTPRoutes(namespace).List(ctx, opts)
			},
...
func (f *hTTPRouteInformer) TypedInformer() HTTPRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1.HTTPRoute](f.factory.InformerFor(&gatewayapiapisv1.HTTPRoute{}, f.defaultInformer))
}
...
func (a *hTTPRouteTypedInformerAdapter) TypedInformer() HTTPRouteIndexInformer {
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1.HTTPRoute](a.Informer())
}
...
func ToHTTPRouteIndexInformer(informer cache.SharedIndexInformer) HTTPRouteIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*gatewayapiapisv1.HTTPRoute](informer)
}
