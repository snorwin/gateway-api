...
func ExtractTLSRouteFrom(tLSRoute *apisv1.TLSRoute, fieldManager string, subresource string) (*TLSRouteApplyConfiguration, error) {
	b := &TLSRouteApplyConfiguration{}
	err := managedfields.ExtractInto(tLSRoute, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v1.TLSRoute"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractTLSRoute(tLSRoute *apisv1.TLSRoute, fieldManager string) (*TLSRouteApplyConfiguration, error) {
...
func ExtractTLSRouteStatus(tLSRoute *apisv1.TLSRoute, fieldManager string) (*TLSRouteApplyConfiguration, error) {
...
func (b *TLSRouteApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *TLSRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TLSRouteApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *TLSRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TLSRouteApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *TLSRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
