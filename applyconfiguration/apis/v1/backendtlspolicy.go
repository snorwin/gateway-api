...
func ExtractBackendTLSPolicyFrom(backendTLSPolicy *apisv1.BackendTLSPolicy, fieldManager string, subresource string) (*BackendTLSPolicyApplyConfiguration, error) {
	b := &BackendTLSPolicyApplyConfiguration{}
