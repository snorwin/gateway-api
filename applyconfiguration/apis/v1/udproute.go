...
func ExtractUDPRouteFrom(uDPRoute *apisv1.UDPRoute, fieldManager string, subresource string) (*UDPRouteApplyConfiguration, error) {
	b := &UDPRouteApplyConfiguration{}
	err := managedfields.ExtractInto(uDPRoute, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v1.UDPRoute"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractUDPRoute(uDPRoute *apisv1.UDPRoute, fieldManager string) (*UDPRouteApplyConfiguration, error) {
...
func ExtractUDPRouteStatus(uDPRoute *apisv1.UDPRoute, fieldManager string) (*UDPRouteApplyConfiguration, error) {
...
func (b *UDPRouteApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *UDPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *UDPRouteApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *UDPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *UDPRouteApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *UDPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
