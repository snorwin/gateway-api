...
// ExtractTCPRouteFrom extracts the applied configuration owned by fieldManager from
// tCPRoute for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// tCPRoute must be a unmodified TCPRoute API object that was retrieved from the Kubernetes API.
// ExtractTCPRouteFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractTCPRouteFrom(tCPRoute *apisv1.TCPRoute, fieldManager string, subresource string) (*TCPRouteApplyConfiguration, error) {
	b := &TCPRouteApplyConfiguration{}
	err := managedfields.ExtractInto(tCPRoute, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v1.TCPRoute"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractTCPRoute(tCPRoute *apisv1.TCPRoute, fieldManager string) (*TCPRouteApplyConfiguration, error) {
	return ExtractTCPRouteFrom(tCPRoute, fieldManager, "")
}

// ExtractTCPRouteStatus extracts the applied configuration owned by fieldManager from
// tCPRoute for the status subresource.
func ExtractTCPRouteStatus(tCPRoute *apisv1.TCPRoute, fieldManager string) (*TCPRouteApplyConfiguration, error) {
	return ExtractTCPRouteFrom(tCPRoute, fieldManager, "status")
}

func (b TCPRouteApplyConfiguration) IsApplyConfiguration() {}
...
func (b *TCPRouteApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *TCPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TCPRouteApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *TCPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TCPRouteApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *TCPRouteApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *TCPRouteApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *TCPRouteApplyConfiguration) GetAPIVersion() *string {
...
func (b *TCPRouteApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
